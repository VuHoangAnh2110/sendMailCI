...
<div id="content" class="grid grid-col-1 border-gray-900/10">
    <div class="p-5">
                    ...
                    <div class=" border-red-800 bg-gray-100 rounded-lg shadow-md sm:mr-10 p-5">
                        ...
                        <div class="mb-4 w-[90%]">
                            <label for="email_subject" class="block text-gray-700 font-semibold mb-2">
                                Tiêu đề email:
                                <span id="requiredStar1" class="requiredStar text-gray-500 align-middle hidden text-red-500"> *!</span>
                            </label>
                            <input type="text" id="email_subject" name="email_subject" 
                            class="inputForm w-full border-gray-300 rounded-md shadow-sm focus:ring focus:ring-indigo-200 focus:border-indigo-300 p-3" 
                        ...
                        <div class="mb-4 w-[90%]">
                            <label for="sender_name" class="block text-gray-700 font-semibold mb-2">
                                Tên người gửi:
                                <span id="requiredStar2" class="requiredStar text-gray-500 align-middle hidden text-red-500"> *!</span>
                            </label>
                        ...
                        <div class="mb-4 w-[90%]">
                            <label for="email_content" class="block text-gray-700 font-semibold mb-2">
                                Mẫu nội dung email:
                                <span id="requiredStar3" class="requiredStar text-gray-500 align-middle hidden text-red-500"> *!</span>
                            </label>
                        ...
                        <div class="mb-4 w-[90%]">
                            <label for="data_file" class="block text-gray-700 font-semibold">
                                ...
                                <span id="requiredStar4" class="requiredStar text-gray-500 align-middle hidden text-red-500"> *!</span>
                            </label>
                            <input type="file" id="data_file" name="data_file" accept=".xls,.xlsx" 
                            class="inputForm text-gray-700 border w-full border-gray-300 rounded-md p-2">
                        </div>
        ...
        <div id="preview" class="sm:mx-20 sm:w-2/3 p-1 mt-8 hidden bg-gray-100 p-4 rounded-md shadow-inner mb-10">
